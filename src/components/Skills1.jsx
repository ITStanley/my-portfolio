    ...
    >
      ...
      <div className="grid grid-cols-1 gap-32 p-3 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-5 mx-auto mt-20 sm:grid-cols-4" data-aos="zoom-in" data-aos-delay="700">
            <div className="h-[130px] p-4 bg-gray-800 rounded-md w-28">
