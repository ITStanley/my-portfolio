  ...
  return (
    <div className="max-w-[1200px] mx-auto sm:py-20 p-5 " id="contact">
      <div className="text-center">
        <h2 className="pt-20 text-4xl font-bold leading-tight primary-color">
          Contact Me
        </h2>
      </div>

      <div className="max-w-[800px] mx-auto" data-aos="fade-down">
        <div className="mt-6 bg-[#161616] rounded-xl">
          <div className="p-10">
            
            <form action="https://getform.io/f/brolmqra" method="POST">
