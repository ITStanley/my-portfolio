      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
        ...
        >
          ...
          <span className="text-2xl font-bold tracking-wider text-center text-white">
            ...
            <span className="text-xl font-bold text-center text-black">
              This Android App contains a platform for users to find plants, connect with plant sellers, and access plant care guides.
            </span>
        ...
        >
          ...
          <span className="text-2xl font-bold tracking-wider text-center text-white">
            ...
            <span className="text-xl font-bold text-center text-black">
              This project is a travel website designed to help users plan and explore travel destinations with various features.
            </span>
            <div className="pt-3 text-center">
              <a
                href="https://github.com/ITStanley/Planteza-Android-App.git"
        ...
        >
          ...
          <span className="text-2xl font-bold tracking-wider text-center text-white">
            ...
            <span className="text-xl font-bold text-center text-black">
              This project is a React Native bookstore app showcasing the UI design for browsing, searching, and purchasing books online.
            </span>
            <div className="pt-3 text-center">
              <a
                href="https://github.com/ITStanley/Planteza-Android-App.git"
